...
1. **Pre Requisite**
   ...
   2. Choose a DID method:
      - `did:web` — generate a DID document and host it on a domain you control. [link](https://github.com/TrustVC/w3c/tree/main/packages/w3c-issuer#2-generate-did-key-pair-and-did-document)
      - `did:key` — generate a self-certifying DID key pair (no hosting required). [link](https://github.com/TrustVC/w3c/tree/main/packages/w3c-issuer#3-generate-a-didkey-key-pair)
